...
import Banner from '../../../public/accessories.jpg'
...
import useAccessoriesProducts from '@/hooks/useAccessoriesProduct'
...
const Accessories = () => {
  const { data: products, isLoading, error } = useAccessoriesProducts();  
  ...
  return (
    <div className='pt-10'>
        ...
        <h1 className="text-zinc-50 text-5xl text-center underline pt-10">Accessories</h1>
