...
import Banner from '../../../public/electronicsac.jpg'
import Image from 'next/image'
import Cloth from '../../../public/clothing.jpg'
import Accesories from '../../../public/access.jpg'
...
import useElectronicsProducts from '@/hooks/useElectronicProducts'
...
const Electronics = () => {
  const { data: products, isLoading, error } = useElectronicsProducts();
  const [currentPage, setCurrentPage] = useState<number>(1);
  if (isLoading) return <div>Loading...</div>;
  if (error) return <div>Error loading products</div>;
  if (!products || products.length === 0) return <div>No accessories products available</div>;
  ...
  return (
    <div className='pt-10'>
        ...
        <h1 className="text-zinc-50 text-5xl text-center underline pt-10">Electronics</h1>
